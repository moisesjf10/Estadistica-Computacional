...
A diferencia de otros métodos más flexibles, la regresión logística multinomial construye fronteras de decisión lineales en el espacio de predictores.

Desde un punto de vista probabilístico, el modelo estima, para cada observación, una distribución de probabilidad sobre las tres especies. La clase asignada será aquella con mayor probabilidad estimada. Para ello, se utiliza la función `softmax`, que transforma las combinaciones lineales de las variables explicativas en probabilidades positivas que suman uno.
